...
@section('admin-content')
    {!! breadcrumbs(['Admin Panel' => 'admin', 'Weapon Categories' => 'admin/weapons/weapon-categories']) !!}
    ...
    <div class="text-right mb-3"><a class="btn btn-primary" href="{{ url('admin/weapons/weapon-categories/create') }}"><i class="fas fa-plus"></i> Create New Weapon Category</a></div>
    @if (!count($categories))
    ...
    @else
            ...
            <tbody id="sortable" class="sortable">
                @foreach ($categories as $category)
                    <tr class="sort-weapon" weapon-id="{{ $category->id }}">
                        ...
                        <td class="text-right">
                            <a href="{{ url('admin/weapons/weapon-categories/edit/' . $category->id) }}" class="btn btn-primary">Edit</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
        ...
        <div class="mb-4">
            {!! Form::open(['url' => 'admin/weapons/weapon-categories/sort']) !!}
